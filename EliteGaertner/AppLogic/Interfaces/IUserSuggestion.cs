...
public interface IUserSuggestion
{
    ...
    void CreateUserSuggestions(ProfileDto contentReceiver, List<HarvestUploadDto> harvestSuggestions);
    ...
    List<HarvestUploadDto> CreateHarvestSuggestions(ProfileDto contentReceiver, List<string> preferences, int preloadCount);
